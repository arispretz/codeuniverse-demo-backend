/**
 * @fileoverview Mongoose schema definition for Local lists.
 * Represents a local list entity within a project, including metadata such as name, due date, and creator.
 * @module schemas/localListSchema
 */
...
/**
 * LocalList schema.
 * Defines the structure for local lists in MongoDB.
 *
 * @property {String} name - The name of the local list (required).
 ...
 */
export const localListSchema = new mongoose.Schema(
  {
